...
If you have either `chromium`, `chrome`, `brave` or `vivaldi` in your PATH, it will work.
...
Then, modify the [teams-for-linux package](https://github.com/NixOS/nixpkgs/blob/nixos-25.11/pkgs/by-name/te/teams-for-linux/package.nix)
